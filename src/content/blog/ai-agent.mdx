...
<div class="sg-card">
  <div class="sg-body">
    <div class="sg-item">
      ...
      <div class="sg-tags">
        <span class="sg-tag">Agent 核心公式</span>
        <span class="sg-tag">五大核心组件</span>
        <span class="sg-tag">六种架构模式</span>
        <span class="sg-tag">Reasoning Loop</span>
        <span class="sg-tag">上下文工程</span>
      </div>
    </div>
    <div class="sg-item">
      <div class="sg-item-head">
      ...
      <div class="sg-time">
        <span class="sg-time-num">18</span>
    ...
    <div class="sg-item">
      ...
      <ul class="sg-list">
        <li>掌握 Agent 核心公式与五大核心组件</li>
        <li>理解 Agent Loop 与 Reasoning Loop 运行机制</li>
        <li>对比六种主流 Agent 架构的适用场景</li>
        <li>建立从 Prompt 到 RAG 再到上下文工程的完整认知</li>
      </ul>
    </div>
  </div>
</div>
